...
import {getRouteTitle, routeNoNeedLogin, routeNoNeedPerm, setRoutesOrder, sortRoutes} from "./scx-route.js";
...
class ScxRouter {
    ...
    canAccessThisRoute(route) {
        ...
        if (this.userInfo.isAdmin) {
            ...
            return this.userInfo.pagePerms.includes(route.name);
        }
    }
