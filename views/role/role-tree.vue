            ...
            <template #default="{ data }">
                ...
                <div class="custom-tree-node">
                    ...
                    <div class="e1">
                        ...
                        <div v-if="data.id === -1&&!readonly" class="e2" @click.stop="append(data)">添加角色</div>
                    </div>
                </div>
...
export default {
    ...
    setup(props, ctx) {
        ...
        function append(data) {
            ...
            //向数据库添加
            req.post("api/role", newInfo).then(res => {
                ElMessage({
                    type: "success",
        ...
        function update() {
            ...
            req.put("api/role", {updateModel: info.value}).then(data => {
                ElMessage({
                    type: "success",
        ...
        function remove(data) {
            ...
            ElMessageBox.confirm(title, "提示", {
                ...
                req.delete("api/role/delete-role-with-children", {id: data.id}).then(d => {
                    //删除成功
                    ElMessage({
                        type: "success",
                        message: "删除成功!",
        ...
        function nodeDrop(dragNode, dropNode, type) {
            ...
            if (type === "inner") {
                ...
                req.put("api/role", {updateModel: dragData}).then(data => {
                    refreshListData();
                    ElMessage({
                        type: "success",
                        message: data.name + " : 更新成功!"
                ...
                req.put("api/role/update-order", list).then(data => {
                    refreshListData();
                    ElMessage({
                        type: "success",
